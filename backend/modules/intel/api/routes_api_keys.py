...
async def list_services():
    ...
    # Only include services that actually use API keys (exclude DefiLlama, CryptoRank)
    ALLOWED_SERVICES = [ServiceType.COINGECKO, ServiceType.COINMARKETCAP, ServiceType.MESSARI]
