  ...
  const EmptyState = () => (
    ...
    >
      <svg width="180" height="180" viewBox="0 0 200 200" fill="none" xmlns="http://www.w3.org/2000/svg">
        <ellipse cx="100" cy="180" rx="60" ry="8" fill="#1e293b" opacity="0.5"/>
        <g transform="translate(50, 30)">
          <ellipse cx="50" cy="90" rx="35" ry="45" fill="#374151"/>
          <ellipse cx="50" cy="90" rx="30" ry="40" fill="#4b5563"/>
          <circle cx="50" cy="35" r="32" fill="#374151"/>
          <circle cx="50" cy="35" r="26" fill="#1f2937"/>
          <ellipse cx="50" cy="35" rx="20" ry="18" fill="#0f172a"/>
          <circle cx="42" cy="30" r="3" fill="#475569" opacity="0.5"/>
          <circle cx="58" cy="38" r="2" fill="#475569" opacity="0.3"/>
          <ellipse cx="12" cy="75" rx="12" ry="18" fill="#4b5563" transform="rotate(-20 12 75)"/>
          <ellipse cx="88" cy="75" rx="12" ry="18" fill="#4b5563" transform="rotate(20 88 75)"/>
          <circle cx="5" cy="55" r="8" fill="#6b7280"/>
          <circle cx="95" cy="55" r="8" fill="#6b7280"/>
          <rect x="30" y="125" width="14" height="30" rx="5" fill="#4b5563"/>
          <rect x="56" y="125" width="14" height="30" rx="5" fill="#4b5563"/>
          <ellipse cx="37" cy="158" rx="10" ry="6" fill="#374151"/>
          <ellipse cx="63" cy="158" rx="10" ry="6" fill="#374151"/>
          <rect x="20" y="70" width="8" height="25" rx="3" fill="#374151"/>
          <rect x="72" y="70" width="8" height="25" rx="3" fill="#374151"/>
        </g>
        <ellipse cx="100" cy="140" rx="50" ry="12" stroke="#475569" strokeWidth="2" fill="none" opacity="0.5"/>
      </svg>
